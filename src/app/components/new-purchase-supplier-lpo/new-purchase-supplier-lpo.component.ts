...
@Component({
  selector: 'app-new-purchase-supplier-lpo',
  templateUrl: './new-purchase-supplier-lpo.component.html',
  styleUrls: ['./new-purchase-supplier-lpo.component.css']
})
export class NewPurchaseSupplierLpoComponent implements OnInit {
