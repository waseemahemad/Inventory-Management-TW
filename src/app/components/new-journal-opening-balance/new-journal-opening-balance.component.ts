...
@Component({
  selector: 'app-new-journal-opening-balance',
  templateUrl: './new-journal-opening-balance.component.html',
  styleUrls: ['./new-journal-opening-balance.component.css']
})
export class NewJournalOpeningBalanceComponent implements OnInit {
  ...
  public reset(){
    ...
    this.fc.contactId.setValue('');
    this.fc.bankId.setValue('');
  }
}
