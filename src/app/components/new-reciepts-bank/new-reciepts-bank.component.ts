...
@Component({
  selector: 'app-new-reciepts-bank',
  templateUrl: './new-reciepts-bank.component.html',
  styleUrls: ['./new-reciepts-bank.component.css']
})
export class NewRecieptsBankComponent implements OnInit {
